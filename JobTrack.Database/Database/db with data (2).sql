...
CREATE TABLE `coversheetdata` (
  ...
  `CoversheetCheckbox` varchar(10) DEFAULT NULL,
  `TaskNumber` varchar(100) NOT NULL,
  `RevisedOnlineDueDate` date DEFAULT NULL,
  `CopyEditDueDate` date DEFAULT NULL,
  `CopyEditStartDate` date DEFAULT NULL,
  `CopyEditDoneDate` date DEFAULT NULL,
  `CopyEditQCDueDate` date DEFAULT NULL,
  `CopyEditQCStartDate` date DEFAULT NULL,
  `CopyEditQCDoneDate` date DEFAULT NULL,
  `CodingDueDate` date DEFAULT NULL,
  `CodingDoneDate` date DEFAULT NULL,
  `OnlineDueDate` date DEFAULT NULL,
  `OnlineDoneDate` date DEFAULT NULL,
  ...
  `isSTP` varchar(20) DEFAULT NULL,
  `CoversheetEditor` varchar(100) DEFAULT NULL,
  `ChargeCode` varchar(100) DEFAULT NULL,
  `FurtherInstruction` varchar(500) DEFAULT NULL,
  `CoversheetGeneral` varchar(200) DEFAULT NULL,
  `SpecialInstruction` varchar(500) DEFAULT NULL,
  `XMLEditing` varchar(50) DEFAULT NULL,
  `CorrectionsDueDate` date DEFAULT NULL,
  `Corrections` varchar(500) DEFAULT NULL,
...
INSERT INTO `coversheetdata` (`CoversheetID`, `ManuscriptID`, `JobNumber`, `BSProductID`, `ServiceNumber`, `ManuscriptLegTitle`, `ManuscriptLegTitleStatus`, `TargetPressDate`, `ActualPressDate`, `LatupAttribution`, `DateReceivedFromAuthor`, `UpdateType`, `JobSpecificInstruction`, `TaskType`, `GuideCard`, `CoversheetCheckbox`, `TaskNumber`, `RevisedOnlineDueDate`, `CopyEditDueDate`, `CopyEditStartDate`, `CopyEditDoneDate`, `CopyEditQCDueDate`, `CopyEditQCStartDate`, `CopyEditQCDoneDate`, `CodingDueDate`, `CodingDoneDate`, `OnlineDueDate`, `OnlineDoneDate`, `EstimatedPages`, `ActualTAT`, `OnlineTimeliness`, `ReasonIfLate`, `CoversheetNumber`, `isSTP`, `CoversheetEditor`, `ChargeCode`, `FurtherInstruction`, `CoversheetGeneral`, `SpecialInstruction`, `XMLEditing`, `CorrectionsDueDate`, `Corrections`, `DateCreated`, `CreatedEmployeeID`, `DateUpdated`, `UpdateEmployeeID`) VALUES
(1, 1, '123479', 'ABCA', '40', 'Law of Superannuation Oct 19 Index', 'New', '1900-01-01', '1900-01-01', 'none', '1900-01-01', 'Manus-Medium', 'EPMS-58454', 'Commentary', NULL, 'Check', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'AAA 40_Task 1_FCPLEG', 'TBD', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-03-07 00:00:00', 1, '2022-03-07 00:00:00', 1);
