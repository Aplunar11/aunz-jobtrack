...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2023 at 04:44 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateQueryCoversheetStatus` (`p_id` INT, `p_coverstatus_id` INT)   BEGIN
    ...
    SET coverstatus_mt_ID = p_coverstatus_id,
		ClosedDate = 
        CASE
			WHEN p_coverstatus_id = 3 THEN utc_timestamp() ELSE null 
		END
    WHERE ID = p_id;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateQueryManuscriptStatus` (`p_id` INT, `p_querystatus_id` INT)   BEGIN
    ...
    SET querystatus_mt_ID = p_querystatus_id,
		ClosedDate = 
        CASE
			WHEN p_querystatus_id = 3 THEN utc_timestamp() ELSE null 
		END
    WHERE ID = p_id;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateQuerySTPStatus` (`p_id` INT, `p_stpstatus_id` INT)   BEGIN
    ...
    SET stpstatus_mt_ID = p_stpstatus_id,
		ClosedDate = 
        CASE
			WHEN p_stpstatus_id = 3 THEN utc_timestamp() ELSE null 
		END
    WHERE ID = p_id;
END$$
...
(4, 1, 'closed reply', '2023-03-16 15:33:28', 'admin'),
(5, 1, 'closed', '2023-03-16 15:35:45', 'admin');
...
INSERT INTO `coversheetquery` (`ID`, `CoversheetNo`, `QueryID`, `CoversheetID`, `covertopic_mt_ID`, `coverstatus_mt_ID`, `covertype_mt_ID`, `FilePath`, `DatePosted`, `PostedBy`, `ClosedDate`) VALUES
(1, NULL, NULL, 1, 1, 3, 1, '', '2023-03-09 15:43:27', 'Patricia.Artajo', '2023-03-16 15:35:50'),
(2, NULL, NULL, 64, 1, 2, 2, '', '2023-03-13 16:14:31', 'Patricia.Artajo', NULL);
...
INSERT INTO `manuscriptquery` (`ID`, `JobID`, `TaskID`, `QueryID`, `querystatus_mt_ID`, `querytopic_mt_ID`, `querytype_mt_ID`, `FilePath`, `DatePosted`, `PostedBy`, `ClosedDate`) VALUES
(1, 10, NULL, NULL, 3, 1, 1, '', '2023-03-09 15:36:29', 'Jennifer.Murray', NULL),
(2, 10, NULL, NULL, 2, 4, 2, '', '2023-03-09 15:44:11', 'Patricia.Artajo', NULL),
(3, 10, NULL, NULL, 1, 1, 1, '', '2023-03-09 15:57:23', 'Jennifer.Murray', NULL),
(4, 21, NULL, NULL, 2, 1, 1, '', '2023-03-09 16:00:49', 'admin', NULL),
(5, 79, NULL, NULL, 3, 4, 3, '', '2023-03-10 07:11:37', 'Jennifer.Murray', NULL),
(6, 2, NULL, NULL, 1, 1, 1, '', '2023-03-10 07:44:25', 'admin', NULL),
(7, 1, NULL, NULL, 3, 1, 1, '', '2023-03-16 15:25:32', 'admin', '2023-03-16 15:33:07');
...
(11, 7, 'test', '2023-03-16 15:25:32', 'admin'),
(12, 7, 'closed', '2023-03-16 15:26:48', 'admin'),
(13, 7, 'closeditem', '2023-03-16 15:33:07', 'admin');
...
(1, 'STP00001', NULL, '1', 'test path', 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'test Instructions', 'Tier 2', 'ABCA', '37', NULL, 'New', '2022-03-10 00:00:00', NULL, 6, '2023-03-16 14:45:58', 6, '2023-03-16 14:45:58', NULL),
(2, 'STP00002', NULL, '1', 'test path', 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'test Instructions', 'Tier 2', 'ABCA', '37', NULL, 'New', '2022-03-10 00:00:00', NULL, 6, '2023-03-16 14:49:05', 6, '2023-03-16 14:49:05', NULL);
...
INSERT INTO `stpquery` (`ID`, `STPNo`, `QueryID`, `StpID`, `stptopic_mt_ID`, `stpstatus_mt_ID`, `stptype_mt_ID`, `FilePath`, `DatePosted`, `PostedBy`, `ClosedDate`) VALUES
(1, NULL, NULL, 3, 1, 1, 1, '', '2023-03-13 16:14:54', 'Patricia.Artajo', NULL),
(2, NULL, NULL, 2, 1, 1, 1, '', '2023-03-15 09:19:48', 'Patricia.Artajo', NULL),
(3, NULL, NULL, 1, 1, 3, 1, '', '2023-03-16 15:16:43', 'CodingSTP', '2023-03-16 15:27:57'),
(4, NULL, NULL, 1, 3, 3, 2, '', '2023-03-16 15:32:33', 'CodingSTP', '2023-03-16 15:32:42');
...
(3, 3, 'test', '2023-03-16 15:16:43', 'CodingSTP'),
(4, 3, 'test close', '2023-03-16 15:17:03', 'CodingSTP'),
(5, 3, 'cancel', '2023-03-16 15:18:06', 'CodingSTP'),
(6, 3, 'closed', '2023-03-16 15:27:57', 'CodingSTP'),
(7, 4, 'test qier', '2023-03-16 15:32:33', 'CodingSTP'),
(8, 4, 'closed', '2023-03-16 15:32:42', 'CodingSTP');
