...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2023 at 11:15 PM
...
INSERT INTO `coversheetdata` (`CoversheetID`, `CoversheetNumber`, `BPSProductID`, `ServiceNumber`, `TaskNumber`, `CoversheetTier`, `Editor`, `ChargeCode`, `TargetPressDate`, `ActualPressDate`, `CurrentTask`, `TaskStatus`, `TaskType`, `GuideCard`, `LocationOfManuscript`, `GeneralLegRefCheck`, `GeneralTOC`, `GeneralTOS`, `GeneralReprints`, `GeneralFascicleInsertion`, `GeneralGraphicLink`, `GeneralGraphicEmbed`, `GeneralHandtooling`, `GeneralNonContent`, `GeneralSamplePages`, `GeneralComplexTask`, `FurtherInstruction`, `UpdateType`, `AcceptedDate`, `JobOwner`, `JobOwnerID`, `UpdateEmailCC`, `IsXMLEditing`, `CodingDueDate`, `CodingStartDate`, `CodingDoneDate`, `CodingStatus`, `Subtask`, `PDFQCStartDate`, `PDFQCDoneDate`, `PDFQAStatus`, `XMLStatus`, `IsOnline`, `OnlineDueDate`, `OnlineStartDate`, `OnlineDoneDate`, `OnlineStatus`, `OnlineTimeliness`, `ReasonIfLate`, `ManuscriptID`, `CoversheetCheckbox`, `Remarks`, `RevisedOnlineDueDate`, `CompletionEmailTemplate`, `DateCreated`, `CreatedEmployeeID`, `DateUpdated`, `UpdateEmployeeID`) VALUES
(1, 'ABCA_34_Task1_Guide1', 'ABCA', '34', 'Task1', 'Tier 2', 'Olivia Zhang', 'ABCA', '2021-04-09 00:00:00', NULL, NULL, 'New', 'COMMENTARY', 'Guide1', 'edited', b'0', b'1', b'0', b'0', b'0', b'1', b'0', b'0', b'0', b'1', b'0', 'TEST', 'Manus-Light', NULL, 'Coding', 4, NULL, b'1', '2023-04-26 00:00:00', '2023-04-22 00:00:00', '2023-04-22 00:00:00', NULL, NULL, '2023-04-22 00:00:00', '2023-04-22 00:00:00', NULL, NULL, b'1', '2023-04-28 00:00:00', NULL, NULL, NULL, NULL, NULL, '1', NULL, 'TEST', '2023-04-20 00:00:00', 'edited', '2023-04-17 08:35:18', 9, '2023-04-17 08:35:18', 4);
...
(14, 1, '2023-04-17 00:33:36', 'New Job ID [1]  has been added.', 'New', '2023-04-17 00:33:36', 8),
(15, 1, '2023-04-17 00:35:18', 'New Job Coversheet ID [1] and Task [Task1] has been added by [Patricia.Artajo].', 'New', '2023-04-17 00:35:18', 9);
...
(1, 'Tier 2', 'ABCA', '34', '2021-04-09 00:00:00', NULL, 1, 'New', 'New', 'New', '2023-04-17 08:35:18', 9, '2023-04-17 08:35:18', 9);
...
(1, 00000001, 'Tier 2', 'ABCA', '34', '2021-04-09 00:00:00', NULL, 'New', 'New', 'New', 'New', '2023-04-17 08:33:36', 8, '2023-04-17 08:33:36', 8);
...
(1, 00000001, 'Tier 2', 'ABCA', '34', 'TEST', NULL, '2021-04-09 00:00:00', NULL, 'TEST', '2023-04-18 00:00:00', 'Manus-Light', 'TEST', 'COMMENTARY', NULL, NULL, NULL, NULL, '2023-04-21 00:00:00', NULL, NULL, 'New', '2023-04-26 00:00:00', NULL, NULL, 'New', '2023-04-28 00:00:00', NULL, NULL, 'New', 'New', NULL, NULL, NULL, NULL, NULL, '2023-04-17 08:33:36', 8, '2023-04-17 08:33:36', 8);
...
(161, 1, 'Manuscript', 'ABCA', '34', 'JobReassignment LE', NULL, 'Jennifer.Murray', '2023-04-17 08:33:36', 'Jennifer.Murray'),
(162, 1, 'Manuscript', 'ABCA', '34', 'JobReassignment PE', NULL, 'Patricia.Artajo', '2023-04-17 08:33:36', 'Jennifer.Murray');
...
--
ALTER TABLE `coversheetdata`
  MODIFY `CoversheetID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `jobcoversheetdata`
  MODIFY `JobCoversheetID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `manuscriptdata`
  MODIFY `ManuscriptID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `transactionlog`
  MODIFY `TransactionLogID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
