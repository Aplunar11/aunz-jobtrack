...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2023 at 07:09 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateQueryCoversheetStatus` (`p_id` INT, `p_coverstatus_id` INT)   BEGIN
	UPDATE coversheetquery
    SET coverstatus_mt_ID = p_coverstatus_id,
		IsReplied = 1
    WHERE ID = p_id;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateQueryManuscriptStatus` (`p_id` INT, `p_querystatus_id` INT)   BEGIN
	UPDATE manuscriptquery
    SET querystatus_mt_ID = p_querystatus_id,
		IsReplied = 1
    WHERE ID = p_id;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateQuerySTPStatus` (`p_id` INT, `p_stpstatus_id` INT)   BEGIN
	UPDATE stpquery
    SET stpstatus_mt_ID = p_stpstatus_id,
		IsReplied = 1
    WHERE ID = p_id;
...
(3, NULL, NULL, 21, 1, 1, 1, '', b'0', '2023-03-18 22:59:17', 'Patricia.Artajo');
...
(1, 10, NULL, NULL, 3, 1, 1, '', b'0', '2023-03-09 15:36:29', 'Jennifer.Murray'),
...
--
ALTER TABLE `manuscriptdata`
  MODIFY `ManuscriptID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `transactionlog`
  MODIFY `TransactionLogID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
