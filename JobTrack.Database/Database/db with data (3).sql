...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllJobCoversheetData` ()   BEGIN
	SELECT * FROM jobdata
	INNER JOIN jobcoversheet ON jobcoversheet.JobID = jobdata.JobID
	INNER JOIN coversheet_mt ON coversheet_mt.CoversheetID = jobcoversheet.CoversheetNo;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCoversheetDataById` (`p_id` INT)   BEGIN
	SELECT * FROM coversheet_mt WHERE CoversheetID = p_id;
END$$
...
--
-- Table structure for table `jobcoversheet`
--

CREATE TABLE `jobcoversheet` (
  `CoversheetNo` varchar(200) NOT NULL,
  `JobID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `jobcoversheet`
--

INSERT INTO `jobcoversheet` (`CoversheetNo`, `JobID`) VALUES
('10', 4),
('3', 1);
...
--
-- Indexes for table `jobcoversheet`
--
ALTER TABLE `jobcoversheet`
  ADD PRIMARY KEY (`CoversheetNo`,`JobID`),
  ADD KEY `JobID_idx` (`JobID`);
