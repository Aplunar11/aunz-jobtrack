...
{
    public class PubSchedService : IPubSchedService
    {
        public MySqlConnection dbConnection = new MySqlConnection(ConfigurationManager.ConnectionStrings["SQLConn"].ConnectionString);
        public MySqlCommand cmd = new MySqlCommand();
        public MySqlDataAdapter adp = new MySqlDataAdapter();

        public PubSchedService() { }

        public async Task<JobCoversheetData> GetPubSchedDataByProductAndServiceAsync(JobCoversheetData model)
        {
            var storedProcedure = "GetPubschedByProductAndService";
